...
devcc = "clang"
devcflags = "-O0 -g -std=c99 -Wall -Wextra -Wmissing-prototypes -fsanitize=address -fno-omit-frame-pointer"
devldflags = "-fsanitize=address -fno-omit-frame-pointer"
devout = "out/devel/"
devbinname = "drte-dev"

testcc = "clang"
testcflags = "-O0 -g -std=c99 -Wall -Wextra -DDRTE_TEST -Wno-implicit-function-declaration -fno-omit-frame-pointer"
testldflags = "-fno-omit-frame-pointer"
testout = "out/devel/"
